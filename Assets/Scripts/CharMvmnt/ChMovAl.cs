...
public class ChMovAl : MonoBehaviour
{
    ...
    public class CharacterCollisionState2D
    {
        ...
        public bool hasCollisionToJump()
        {
    ...
    {
        //set gravity
        //gravity = (-2f * topHeight * topLatSpeed * topLatSpeed) / (topLatMovmt * topLatMovmt);
    ...
    //public float GiveInitVelocity()
    //{
    //    float initVelocity;

    //    initVelocity = 2 * topHeight / jumpTime;
    ...
    public void CheckForWalls()
    {
        ...
        Debug.DrawRay(transform.position, Vector2.left * (boxCollider.bounds.extents.x + 0.1f), Color.green);


        if (Physics2D.Raycast(transform.position, Vector2.right, boxCollider.bounds.extents.x + 0.05f, platformMask & ~oneWayPlatformMask))
            collisionState.right = true;
